      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-red">
            <div class="inner">
              <h3>40</h3>
              <p>KELAS : X IPA 5 <br /> <sup>(BAHASA JAWA)</sup></p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-book"></i>
            </div>
            <div class="small-box-footer text-center">
              <a href="" class="btn btn-xs btn-danger"><i class="fa fa-file-archive-o"></i></a>
              <a href="" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#pilih_penilaian_modal">
                <i class="fa fa-edit"></i>
              </a>
            </div>
          </div>
